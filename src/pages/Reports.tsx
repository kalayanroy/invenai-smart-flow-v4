...
export const Reports = () => {
  ...
  const generatePDF = () => {
      ...
      <html>
        ...
        <body>
          <div class="company-header">
            <img src="/lovable-uploads/6873bc5a-b4b1-4b2e-aea3-20c042a2087c.png" alt="Company Logo" class="company-logo" />
            <div class="company-name">Nahar Enterprise</div>
            <div class="company-details">Abdul Kadar market, member bari road, National University, gazipur city corporation</div>
            <div class="company-details">Phone: 01712014171</div>
          </div>
    ...
    content += `
          <div class="footer">
            <p><strong>Nahar Enterprise</strong></p>
            <p>Abdul Kadar market, member bari road, National University, gazipur city corporation</p>
            <p>Phone: 01712014171</p>
            <p style="margin-top: 10px; font-style: italic;">Generated by Inventory Management System</p>
          </div>
        </body>
      </html>
    `;
